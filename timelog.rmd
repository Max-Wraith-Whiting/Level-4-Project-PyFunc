...
* Project Name: Python-like Functional Programming Language with Integrated Type-System 
...
* *0.5 hour* Researching programming language concepts of significance

### 22 September 2023

* *1 hour* Meeting to discuss new proposal with S. Fowler
* *2 hour* Research on type systems and ambiguous parsing
...
* *4 hour* Researching formal syntax definitions and working on implementing a rudimentary scanner and parser
...
* *7.0 hour* Finalising dissertation submission.