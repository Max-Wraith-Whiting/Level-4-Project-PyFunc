...
\begin{itemize}
    ...
    % Further, quantified variables not occuring in the monotpye can be dropped.
    % \item Context and typing
...
\section{Parsing ,Lexer and Abstract Syntax Tree}
...
\textbf{Whitespace Indentation Conversion}
...
A naive description of a type variable could be something like: "A pair made of a quantifier and 

Before type variables can be implemented, the concept of quantifiers needs to be described.
