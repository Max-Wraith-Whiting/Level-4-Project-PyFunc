...
\begin{itemize}
    ...
    \item \textbf{Hindley-Milner Type System:} The type system is a fundamental structure that the language hinges upon, and therefore any implementation lacking it is a failure.
\end{itemize}
